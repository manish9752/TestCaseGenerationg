...
@Table(name="VALID_DEAL")
 public class InvalidDeal implements Serializable {
	...
	private int amount_ordering_currency;
	...
	public int getAmount_ordering_currency() {
		return amount_ordering_currency;
	}

	public void setAmount_ordering_currency(int amount_ordering_currency) {
	...
	public InvalidDeal(String deal_id, String from_currency_iso_code, String to_currency_iso_code, String time_stamp,
			int amount_ordering_currency, String file_id) {
		super();
		this.deal_id = deal_id;
		this.from_currency_iso_code = from_currency_iso_code;
		this.to_currency_iso_code = to_currency_iso_code;
